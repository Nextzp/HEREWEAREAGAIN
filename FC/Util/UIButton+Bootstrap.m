...
- (void)mainStyle{
    [self bootstrapStyle];
    self.backgroundColor = [UIColor colorWithHexString:kAPPMainColorStr];
    self.layer.borderColor = [[UIColor colorWithHexString:kAPPMainColorStr] CGColor];
    [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithHexString:kAPPMainColorStr]] forState:UIControlStateHighlighted];
}
